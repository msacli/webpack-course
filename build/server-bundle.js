...
module.exports = {"title":"Our first Post","author":"Link","__content":"<h1 id=\"long-ago-in-the-kingdom\">Long ago in the Kingdom</h1>\n<p>Our hero wakes up. He is alone. He must find his sword.</p>\n"}
...
var PORT = Object({"NODE_ENV":"development"}).PORT || 8080;
server.listen(PORT, function () {
  console.log("Server listening on http://localhost:" + PORT + " in " + "development");
});
;
